...
- [ ] **EOD-Validierung ausstehend:** `--verify` ist erst nach dem nächsten 23:00-UTC-Cron aussagekräftig (dann existiert ein Live-Punkt neuer Bauart). Intraday nicht prüfbar, weil Optionspreise und Spot dann aus verschiedenen Zeitpunkten stammen.
