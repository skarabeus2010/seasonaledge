...
- **Institutionelle Geldstroeme**: Pensionsfonds investieren regelmaessig zu bestimmten Zeitpunkten
- **Steuerliche Effekte**: Tax-Loss-Selling im Dezember, Window-Dressing zum Quartalsende
- **Psychologische Muster**: Optimismus zum Jahresstart, Vorsicht vor dem Sommer
- **Kalender-Events**: OPEX-Tage, Notenbank-Sitzungen, Feiertage
...
- **Win-Rate**: Wie oft war ein bestimmter Zeitraum positiv? Eine Win-Rate von 70% bedeutet: In 7 von 10 Jahren war der Monat im Plus.
- **Durchschnittsrendite**: Der Mittelwert aller Renditen in diesem Zeitraum.
- **Normalisierte Rendite**: Jedes Jahr startet bei 100, taegliche Returns kumulieren darauf.
