---
title: "Rendite steigt, Drawdown fällt — Wie passt das zusammen? Ein Blick unter die Motorhaube"
seo_title: "Rendite vs Drawdown erklärt: Warum beides stimmt (2026)"
...
<!--
Keyword-Plan:
- Haupt-Keyword: Rendite vs Drawdown
- Neben-Keywords: Drawdown Berechnung, saisonaler Drawdown, Dekadenzyklus, Durchschnittsverlauf, Jahreshoch, kumulierte Rendite
- LSI-Keywords: Risikokennzahl, Verlustphase, Recovery, Mittelwert, Kohortenanalyse, historische Muster
-->
...
![Ø Renditeverlauf x6-Jahre DJI](dekadenzyklus-rendite-x6-dji.png)
...
![Ø Drawdown-Verlauf x6-Jahre DJI](dekadenzyklus-drawdown-x6-dji.png)
...
- **1906:** Tief im Herbst (Bankers' Panic)
- **1946:** Tief im Oktober (Nachkriegs-Korrektur)
- **1966:** Tief im Oktober (Bärenmarkt)
- **2016:** Tief im Februar (China-Sorgen), schnelle Recovery
...
- **Rendite allein reicht nicht.** Eine Strategie mit +10 % Jahresrendite und –30 % Drawdown fühlt sich brutal anders an als eine mit +10 % und –8 % Drawdown. Der Drawdown zeigt die emotionale Belastung.

- **Die zweite Jahreshälfte ist risikoreicher.** Der Ø-Drawdown vertieft sich ab Mai deutlich. Das deckt sich mit dem historischen Muster "Sell in May" — allerdings nicht wegen fallender Renditen, sondern wegen tieferer Rücksetzer vom Jahreshoch.

- **Vergleiche den aktuellen Drawdown mit dem historischen Ø.** Die goldene 2026-Linie im Chart zeigt: Das aktuelle Jahr liegt aktuell unter dem historischen Durchschnitt der x6-Kohorte. Auf SeasonAlpha siehst du das für jeden Ticker sofort — inklusive Perzentil-Einordnung.
...
Auf [seasonalpha.ai](https://seasonalpha.ai) kannst du Rendite und Drawdown für über 500 Assets vergleichen — mit 130 Jahren Historie für den Dow Jones.
...
**LinkedIn:** Rendite steigt, Drawdown fällt — ein Widerspruch? 🤔 Wir erklären mit zwei Charts und 130 Jahren Dow Jones, warum beides gleichzeitig stimmt. Der Schlüssel liegt in der Berechnung. Kurz: Rendite misst "wo stehe ich insgesamt", Drawdown misst "wie weit bin ich von meinem Besten entfernt". Beides zusammen = das vollständige Bild. 📊📉 https://seasonalpha.ai/blog/rendite-vs-drawdown-erklaert/

**Twitter/X:** Rendite steigt 📈 Drawdown fällt 📉 — Widerspruch? Nein! Wir erklären warum beides stimmt. 130 Jahre DJI Daten. seasonalpha.ai/blog/rendite-vs-drawdown-erklaert/ #Börse #Drawdown #SeasonAlpha

#### Interne Verlinkung
- Blog: "Drawdown verstehen: Was Crash-Jahre über die Börse verraten"
- SeasonAlpha: Dekadenzyklus → Drawdown & Risiko
- SeasonAlpha: Jahreszyklus → Saisonaler Drawdown

#### Content-Ideen (Folgeartikel)
- "Drawdown nach Sektor: Tech vs Energie vs Gesundheit"
- "Sharpe Ratio vs Maximum Drawdown: Welche Risikokennzahl ist besser?"
- "Der perfekte Einstieg: Drawdown als Timing-Signal?"
-->
