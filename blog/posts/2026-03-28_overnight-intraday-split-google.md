...
![Overnight vs. Intraday Split bei Google nach Wochentagen](overnight-intraday-split-googl.png)
...
1. Ticker in der Sidebar eingeben (z.B. `GOOGL`)
2. Seite **„Wochentage"** öffnen
3. Den Expander **„Overnight vs. Intraday Split"** aufklappen
4. Das Balkendiagramm zeigt dir beide Komponenten getrennt — inklusive Gesamtrendite Σ
