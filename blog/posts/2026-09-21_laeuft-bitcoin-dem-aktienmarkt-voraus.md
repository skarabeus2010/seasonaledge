---
title: "Läuft Bitcoin dem Aktienmarkt voraus? 12 Jahre Daten, 3020 Handelstage"
seo_title: "Läuft Bitcoin dem Aktienmarkt voraus? 12 Jahre Daten"
slug: laeuft-bitcoin-dem-aktienmarkt-voraus
date: 2026-09-21
category: education
...
<!--
Keyword-Plan:
- Haupt-Keyword: Läuft Bitcoin dem Aktienmarkt voraus
- Neben-Keywords: Bitcoin Frühindikator, Korrelation Bitcoin S&P 500, Bitcoin Aktienmarkt Zusammenhang, Lead-Lag-Analyse, Bitcoin Risikoappetit, Krypto und Aktien Korrelation, BTC SPY Korrelation, Ether S&P 500
- LSI: Tagesrendite, Verschiebung, Signifikanz, p-Wert, Basisrate, Trefferquote, Ereignisstudie, Risk-On, Zufallsband
-->
...
![Balkendiagramm: SPY drei Wochen nach einem Krypto-Anstieg, je Schwelle ab 3, 5, 10 und 20 Prozent, getrennt nach Bitcoin und Ether, mit p-Werten unter den Balken — ab 10 Prozent liegen die Balken deutlich über dem Marktdurchschnitt von +0,85 Prozent](laeuft-bitcoin-dem-aktienmarkt-voraus/3_staerke_btc_eth.png)
...
![Zwei Ereignispfade von SPY um das Ereignis herum, links nach einer Bitcoin-Rallye (n = 12), rechts nach einem Bitcoin-Einbruch (n = 10), jeweils mit dem 5.- bis 95.-Perzentil-Band aus 2000 zufälligen Verschiebungen — der mittlere Pfad verlässt das Band nicht](laeuft-bitcoin-dem-aktienmarkt-voraus/2_ereignispfad.png)
...
**LinkedIn:**
„Bitcoin läuft dem Aktienmarkt voraus" — wir haben die These an 3020 gemeinsamen Handelstagen seit 2014 gemessen.
Ergebnis: Die Korrelation zwischen BTC und SPY ist bei Verschiebung 0 am höchsten (+0,36 bis +0,45 seit 2020) und bei einem Tag Vorlauf praktisch null. Vor 2019: +0,017, also gar keine Kopplung.
Die verbreitete 5-Prozent-These fällt durch (+0,78 % nach 3 Wochen gegen +0,85 % Basisrate). Etwas übrig bleibt nur bei sehr großen Bewegungen: ab BTC +10 % → SPY +2,06 % (p = 0,022), ab ETH +20 % → +2,85 % (p = 0,020). Schwelle nachträglich gewählt, Trefferquote unverändert bei ~65 %.
Welche Krypto-Aktien-Regel würdet ihr gern geprüft sehen? → seasonalpha.ai

**Twitter/X:**
Läuft Bitcoin dem Aktienmarkt voraus? 3020 Handelstage sagen: nein.
Korrelation BTC/SPY am selben Tag +0,42, einen Tag später ~0.
Die 5-%-These: +0,78 % nach 3 Wochen — Basisrate +0,85 %.
Erst ab +10 % wird es messbar (+2,06 %, p=0,022).
#Bitcoin #Börse #SeasonAlpha

#### Interne Verlinkung
- /intermarket-shocks (Übertragung zwischen Märkten)
- /risikozyklus (Risikoneigung im Jahresverlauf)
- /scanner (auffällige Kalenderfenster je Ticker)
- /blog/monthly-10-strategie/ (Methodik: Basisrate und Zerlegung)

#### Content-Ideen (Folgeartikel)
- „Dreht Bitcoin am Wochenende vor? Der Montags-Test" — nutzt die 24/7-Handelszeit als echten Informationsvorsprung
- „Was die Korrelation 2020 eingeschaltet hat" — Liquidität, Zinsen und der institutionelle Einstieg
- „Gold, Kupfer, Bitcoin: Welcher Markt dreht wirklich zuerst?" — dieselbe Lead-Lag-Methodik über mehrere Assets
-->
