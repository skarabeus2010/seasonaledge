---
title: "Der schlechteste DAX-Monat: Was 38 Jahre Saisonalität verraten"
seo_title: "Der schlechteste DAX-Monat — 38 Jahre Statistik"
slug: schlechtester-dax-monat-saisonalitaet
date: 2026-06-15
category: education
tags: [dax, saisonalitaet, september-effekt, monatszyklus, boersenmonate, statistik]
description: "Welcher Monat ist für den DAX historisch am schwächsten? 38 Jahre Daten zeigen einen klaren Verlierer — und die stärksten Monate im Jahresverlauf."
ticker: ^GDAXI
status: published
---
...
<!--
Keyword-Plan:
- Haupt-Keyword: schlechtester DAX-Monat
- Neben-Keywords: DAX Saisonalität, September-Effekt, beste Börsenmonate, DAX Monatsrendite, Monatszyklus DAX, DAX September, DAX historische Rendite
- LSI: Trefferquote, Win-Rate, Jahresverlauf, normalisierte Renditen, Spätsommer-Schwäche, Q4-Rally
-->
...
**LinkedIn:** Welcher Monat ist für den DAX historisch der schwächste? Über 38 Jahre ist die Antwort überraschend eindeutig: der September — im Schnitt −2 % und nur in 39 % der Jahre positiv. Dahinter steht ein klares Spätsommer-Muster, dem eine starke Jahresend-Phase folgt. Wir haben jeden Kalendermonat seit DAX-Start 1988 ausgewertet. 📉 Welcher Monat überrascht dich am meisten? Daten + interaktive Charts: seasonalpha.ai

**Twitter/X:** Der schlechteste DAX-Monat seit 1988? 📉 Der September: Ø −2,0 %, nur 39 % der Jahre positiv. Bester Monat: April (+2,7 %, 72 %). #Börse #DAX #Saisonalität #SeasonAlpha

#### Interne Verlinkung
- /monatszyklus (interaktiver Monatszyklus je Ticker)
- /blog/dax-vs-sp500-saisonalitaet/ (DAX vs. S&P 500 im Vergleich)
- /ueber-uns (Methodik)

#### Content-Ideen (Folgeartikel)
- "Der beste DAX-Monat: Warum der April heraussticht"
- "September-Effekt im Vergleich: DAX vs. S&P 500 vs. Nikkei"
- "Sell in May am DAX: Was die Sommermonate wirklich kosten"
-->
