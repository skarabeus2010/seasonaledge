---
title: "The Worst Month for the DAX: What 38 Years of Seasonality Reveal"
seo_title: "The Worst Month for the DAX — 38 Years of Data"
slug: worst-dax-month-seasonality
de_slug: schlechtester-dax-monat-saisonalitaet
date: 2026-06-15
category: education
tags: [dax, seasonality, september-effect, monthly-cycle, stock-market-months, statistics]
description: "Which month is historically weakest for the DAX? 38 years of data reveal a clear loser — and the strongest months across the year."
ticker: ^GDAXI
status: published
---
...
<!--
Keyword-Plan:
- Main keyword: worst month for the DAX
- Secondary: DAX seasonality, September effect, best stock market months, DAX monthly return, DAX September, monthly cycle DAX
- LSI: hit rate, win rate, yearly pattern, normalized returns, late-summer weakness, Q4 rally
-->
...
**LinkedIn:** Which month is historically the worst for the DAX? Over 38 years the answer is surprisingly clear: September — averaging −2 % and positive in only 39 % of years. Behind it sits a clear late-summer pattern, followed by a strong year-end. We analysed every calendar month since the DAX launched in 1988. 📉 Which month surprises you most? Data + interactive charts: seasonalpha.ai

**Twitter/X:** The worst DAX month since 1988? 📉 September: avg −2.0 %, positive in only 39 % of years. Best month: April (+2.7 %, 72 %). #Stocks #DAX #Seasonality #SeasonAlpha

#### Internal linking
- /en/monatszyklus (interactive monthly cycle per ticker)
- /en/blog/dax-vs-sp500-saisonalitaet/ (DAX vs S&P 500)
- /en/about (methodology)

#### Content ideas (follow-ups)
- "The best DAX month: why April stands out"
- "September effect compared: DAX vs S&P 500 vs Nikkei"
- "Sell in May on the DAX: what the summer months really cost"
-->
