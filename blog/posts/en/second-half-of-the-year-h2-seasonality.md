---
title: "The Second Half of the Year in Stocks: What H2 Seasonality Really Shows"
seo_title: "Second Half of the Year — H2 Stock Seasonality"
slug: second-half-of-the-year-h2-seasonality
de_slug: zweite-jahreshaelfte-h2-saisonalitaet
date: 2026-06-27
category: education
...
<!--
Keyword-Plan:
- Main keyword: second half of the year stocks
- Secondary: H2 seasonality, Q4 rally, summer doldrums, third quarter stocks, fourth quarter stocks, S&P 500 second half, DAX second half, year-end rally
- LSI: win rate, hit rate, normalized returns, monthly cycle, September weakness, half-year review, seasonal pattern, quarterly return
-->
...
1. **Averages hide dispersion.** The +6.9 % in the DAX Q4 is a mean of strong gains and a few deep loss years. In 2008, for instance, the fourth quarter fell massively in the middle of the financial crisis — the pattern offered no protection.
2. **Exogenous shocks override seasonality at any time.** A rate decision, a geopolitical event or a trade conflict can break any seasonal pattern. We saw this recently with the [Sell-in-May effect in 2026](/en/blog/sell-in-may-halftime-2026/), where a trade-deal rally overrode the typical summer weakness.
3. **Even a strong Q4 is never certain.** In roughly one year in five (S&P 500) or one in ten (DAX), the fourth quarter closed negative. Confusing "reliable" with "guaranteed" misreads the statistics.
...
You can explore the interactive [monthly cycle](/en/monatszyklus) and the [seasonal yearly cycle](/en/jahreszyklus) for any ticker on SeasonAlpha. To follow the summer phase actively, the [sector rotation](/en/sektor-rotation) shows which sectors historically held up more defensively in weaker phases, and the [risk cycle](/en/risikozyklus) shows the current market regime.
...
**LinkedIn:** 📊 Halftime in the market — what now? The second half of the year looks unremarkable on average, but it is actually split: a weak third quarter (September as the brake) and then one of the most reliable phases of the year. The fourth quarter closed positive in 79 % of years for the S&P 500 and 89 % for the DAX. We analysed 56 years of S&P 500 and 38 years of DAX data. Which phase surprises you most? Data + interactive charts: seasonalpha.ai

**Twitter/X:** Second half of the year in stocks? 📈 Weak Q3 (September drags), then strong Q4: S&P 500 positive in 79 % of years, DAX even 89 %. The average is misleading — the seasonality is split. #Stocks #Seasonality #SeasonAlpha

#### Internal linking
- /en/monatszyklus (interactive monthly cycle per ticker)
- /en/jahreszyklus (seasonal yearly cycle)
- /en/sektor-rotation (defensive vs. cyclical sectors in summer)
- /en/risikozyklus (current market regime)
- /en/blog/sell-in-may-halftime-2026/ (summer anomaly 2026)
- /en/blog/worst-dax-month-seasonality/ (the September effect in detail)

#### Content ideas (follow-ups)
- "The Santa Claus Rally: what the last 5 trading days of the year bring"
- "Q4 seasonality by sector: which industries drive the year-end rally?"
- "Does the first half predict the second? H1-to-H2 correlation in numbers"
-->
