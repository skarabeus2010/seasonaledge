...
SYMBOLS = {
    ...
    "SMH": {
        ...
        "währung":      "USD",
        "exchange":     "NASDAQ",
        "beschreibung": "US-Halbleiter ETF (VanEck)",
    },
    "SOXX": {
    ...
    "XBI": {
        ...
        "währung":      "USD",
        "exchange":     "NYSE",
        "beschreibung": "US-Biotech ETF (gleichgewichtet)",
    },
    "XHB": {
    ...
    "XLRE": {
        ...
        "währung":      "USD",
        "exchange":     "NYSE",
        "beschreibung": "US-Immobiliensektor ETF",
    },
    "XME": {
        ...
        "währung":      "USD",
        "exchange":     "NYSE",
        "beschreibung": "US-Metalle & Bergbau ETF",
    },
    "URA": {
        ...
        "währung":      "USD",
        "exchange":     "NYSE",
        "beschreibung": "Uran & Kernenergie ETF",
    },
    "KWEB": {
        ...
        "währung":      "USD",
        "exchange":     "NYSE",
        "beschreibung": "China-Internet ETF",
    },
    "MAGS": {
        ...
        "währung":      "USD",
        "exchange":     "NASDAQ",
        "beschreibung": "Magnificent Seven ETF (7 Tech-Giganten)",
    },
    "CNXT": {
        ...
        "währung":      "USD",
        "exchange":     "NYSE",
        "beschreibung": "China ChiNext Growth ETF",
    },
    "TAN": {
        ...
        "währung":      "USD",
        "exchange":     "NYSE",
        "beschreibung": "Solar-Energie ETF",
    },
    "ITB": {
    ...
    "MMM": {
        ...
        "währung":      "USD",
        "exchange":     "NYSE",
        "beschreibung": "3M Company — Industrie-Konglomerat",
    },
    "NKE": {
        "name":         "Nike",
        "kategorie":    "US-Aktie",
        "währung":      "USD",
        "exchange":     "NYSE",
        "beschreibung": "Nike Inc. — Sportartikel",
    },
    "SHW": {
        ...
        "währung":      "USD",
        "exchange":     "NYSE",
        "beschreibung": "Sherwin-Williams — Farben & Lacke",
    },
    "TRV": {
        "name":         "Travelers",
        "kategorie":    "US-Aktie",
        "währung":      "USD",
        "exchange":     "NYSE",
        "beschreibung": "The Travelers Companies — Versicherung",
    },
    "AAPL": {
        "name":         "Apple",
        "kategorie":    "US-Aktie",
    ...
    # ── EU-EINZELAKTIEN ────────────────────────────────────────────────────────
    # DAX-40-Mitglieder (XETRA, ergänzt 2026-06-13)
    "BAYN.DE": {"name": "Bayer", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Bayer AG — Pharma & Agrarchemie"},
    "BEI.DE": {"name": "Beiersdorf", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Beiersdorf AG — Konsumgüter (Nivea)"},
    "BNR.DE": {"name": "Brenntag", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Brenntag SE — Chemiedistribution"},
    "CBK.DE": {"name": "Commerzbank", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Commerzbank AG — Großbank"},
    "CON.DE": {"name": "Continental", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Continental AG — Automobilzulieferer"},
    "DTG.DE": {"name": "Daimler Truck", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Daimler Truck Holding — Nutzfahrzeuge"},
    "DBK.DE": {"name": "Deutsche Bank", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Deutsche Bank AG — Großbank"},
    "DB1.DE": {"name": "Deutsche Börse", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Deutsche Börse AG — Börsenbetreiber"},
    "DHL.DE": {"name": "DHL Group", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "DHL Group (Deutsche Post) — Logistik"},
    "EOAN.DE": {"name": "E.ON", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "E.ON SE — Energieversorger"},
    "FRE.DE": {"name": "Fresenius", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Fresenius SE — Gesundheitskonzern"},
    "FME.DE": {"name": "Fresenius Medical Care", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Fresenius Medical Care — Dialyse"},
    "G1A.DE": {"name": "GEA Group", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "GEA Group AG — Maschinenbau (Lebensmitteltechnik)"},
    "HNR1.DE": {"name": "Hannover Rück", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Hannover Rück SE — Rückversicherung"},
    "HEI.DE": {"name": "Heidelberg Materials", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Heidelberg Materials AG — Baustoffe"},
    "HEN3.DE": {"name": "Henkel (Vz)", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Henkel AG — Konsumgüter & Klebstoffe"},
    "IFX.DE": {"name": "Infineon", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Infineon Technologies — Halbleiter"},
    "MRK.DE": {"name": "Merck KGaA", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Merck KGaA Darmstadt — Pharma & Spezialchemie"},
    "MTX.DE": {"name": "MTU Aero Engines", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "MTU Aero Engines — Triebwerke"},
    "PAH3.DE": {"name": "Porsche SE", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Porsche Automobil Holding SE — Beteiligungsholding"},
    "QIA.DE": {"name": "Qiagen", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Qiagen N.V. — Diagnostik & Biotech"},
    "RWE.DE": {"name": "RWE", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "RWE AG — Energieversorger"},
    "G24.DE": {"name": "Scout24", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Scout24 SE — Digitale Marktplätze (ImmoScout)"},
    "SHL.DE": {"name": "Siemens Healthineers", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Siemens Healthineers — Medizintechnik"},
    "SY1.DE": {"name": "Symrise", "kategorie": "EU-Aktie", "währung": "EUR", "exchange": "XETRA", "beschreibung": "Symrise AG — Duft- & Geschmackstoffe"},
