...
- **Ehrlichkeits-/Meta-Duktus (Claude-Sprache — HART verboten):** die eigene Redlichkeit beteuern statt einfach die Grenze zu nennen. Verboten: „ehrlich/ehrliche Einordnung", „Ehrlichkeit zuerst", „honestly labeled/labelled", „Honesty first", „honest assessment", „we stress this deliberately / das betonen wir bewusst", „Cleanliness/Sourcing matters here", sowie SEO-Meta-Jargon im Fließtext („YMYL", „Your Money or Your Life"). → Grenze/Vorbehalt **direkt** benennen („Wichtig:", „Grenzen:", „klar gekennzeichnet", „Kein Signal") ohne die Selbst-Beteuerung. Faustregel: Wenn ein Satz betont, wie ehrlich/transparent/sauber man ist, statt die Sache zu sagen, streichen.
