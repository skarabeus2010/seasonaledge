...
> Version 29.0 | 2026-04-10 (Abend) | SEO-Foundation-Layer komplett: OG-Images + Meta-Tags + Sitemap-Auto-Discovery + Breadcrumbs + robots.txt AI-Policy + Hero-Titles + SearchAction JSON-LD + IndexNow + www-Redirect + Programmatic Thin-Content auf noindex | Blog-Suche | Footer-Redesign | Details → `docs/SEO_MARKETING.md`
