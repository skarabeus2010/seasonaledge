...
> Version 30.0 | 2026-04-10 (Spät-Abend) | **Feature #3 Saisonal-Scanner LIVE** (MVP Frontend + Full-Backend + Weekly Cron) + SEO-Foundation-Layer komplett + Blog-Suche + Footer-Redesign + Mobile-Fixes | Details → `docs/SEO_MARKETING.md` | Roadmap: 3/5 Features live
