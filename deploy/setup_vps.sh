...
echo "   docker compose run --rm certbot certonly --webroot -w /var/www/certbot -d seasonalalpha.ai -d www.seasonalalpha.ai --email deine@email.de --agree-tos --no-eff-email"
echo ""
echo "3. App starten:"
...
echo ""
echo "Die App ist dann erreichbar unter: https://seasonalalpha.ai"
echo ""
